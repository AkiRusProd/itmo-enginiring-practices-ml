...
### 2.1 Настроить выбранный инструмент для управления конфигурациями
...
### 2.2 Создать конфигурации для разных алгоритмов
...
### 2.3 Настроить валидацию конфигураций
...
### 2.4 Создать систему композиции конфигураций
...
### 4.1	Создать отчет в формате Markdown
Выполнено
### 4.2	Описать настройку выбранных инструментов
Выполнено
### 4.3	Добавить скриншоты результатов
Выполнено
### 4.4	Сохранить отчет в Git репозитории
Выполнено
