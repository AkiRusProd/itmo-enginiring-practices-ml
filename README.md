...
o	Настроить выбранный инструмент для управления конфигурациями
o	Создать конфигурации для разных алгоритмов
o	Настроить валидацию конфигураций
o	Создать систему композиции конфигураций
3.	Интеграция и тестирование (2 балла):
o	Интегрировать выбранные инструменты
o	Создать систему мониторинга выполнения
o	Настроить уведомления о результатах
o	Протестировать воспроизводимость
4.	Отчет о проделанной работе (1 балл):
o	Создать отчет в формате Markdown
o	Описать настройку выбранных инструментов
